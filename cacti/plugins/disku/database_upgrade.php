	...
	case "--force-ver":
		...
		switch(rtm_plugin_ver_validate($force_version)){
			case -1:
				...
				exit;
			case  1:
				cacti_log("ERROR: Invalid disku plugin version number: '$force_version'", true, 'UPGRADE');
				exit;
			case 0:
			default:
				cacti_log("NOTE: Upgrading disku to v$force_version ...", true, 'UPGRADE');;
		}
		break;
	case "--type":
...
rtm_plugin_upgrade_ga($disku_version, $disku_current_version, 'disku');

function display_version() {
	print 'IBM Spectrum LSF RTM Database Upgrader ' . get_disku_version() . "\n";
	print rtm_copyright();
}

/*	display_help - displays the usage of the function */
function display_help () {
	print "database_upgrade.php " . get_disku_version() . "\n\n";
	print "Upgrade Disk Monitoring plugin dababase, host/graph/datasource template, and dataquery.\n";
	print "Usage:\n";
