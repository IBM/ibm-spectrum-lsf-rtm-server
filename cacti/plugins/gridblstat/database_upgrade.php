...
rtm_plugin_upgrade_ga($gridblstat_version, $gridblstat_current_version, 'gridblstat');

function display_version() {
	print 'IBM Spectrum LSF RTM Database Upgrader ' . get_gridblstat_version() . "\n";
	print rtm_copyright();
}

/*	display_help - displays the usage of the function */
function display_help () {
	print "database_upgrade.php " . get_gridblstat_version() . "\n\n";
	print "Upgrade License Scheduler plugin dababase, host/graph/datasource template, and dataquery.\n";
	print "Usage:\n";
