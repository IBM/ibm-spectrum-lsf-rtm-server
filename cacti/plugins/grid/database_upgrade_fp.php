...
rtm_plugin_upgrade_fp($grid_version, $grid_current_version);

function display_version() {
	print 'IBM Spectrum LSF RTM Fix Pack Database Upgrader ' . get_grid_version() . "\n";
	print rtm_copyright();
}
...
function display_help () {
	...
	print "Upgrade Grid plugin dababase, host/graph/datasource template, and dataquery for FixPack deployment.\n";
	print "Usage:\n";
