...
function display_version() {
	print 'IBM Spectrum LSF RTM Database Upgrader ' . get_gridalarms_version() . "\n";
	print rtm_copyright();
}

/*	display_help - displays the usage of the function */
function display_help () {
	print "database_upgrade.php " . get_gridalarms_version() . "\n\n";
	print "Upgrade Alerting plugin dababase, host/graph/datasource template, and dataquery.\n";
	print "Usage:\n";
