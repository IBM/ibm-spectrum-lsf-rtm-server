...
rtm_plugin_upgrade_ga($heuristics_version, $heuristics_current_version, 'heuristics');

function display_version() {
	print 'IBM Spectrum LSF RTM Database Upgrader ' . get_heuristics_version() . "\n";
	print rtm_copyright();
}

/*	display_help - displays the usage of the function */
function display_help () {
	print "database_upgrade.php " . get_heuristics_version() . "\n\n";
	print "Upgrade Heuristics Dashboard plugin dababase, host/graph/datasource template, and dataquery.\n";
	print "Usage:\n";
