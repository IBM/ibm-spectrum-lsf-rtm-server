...
rtm_plugin_upgrade_ga($license_version, $license_current_version, 'license');

function display_version() {
	print 'IBM Spectrum LSF RTM Database Upgrader ' . get_license_version() . "\n";
	print rtm_copyright();
}

/*	display_help - displays the usage of the function */
function display_help () {
	print "database_upgrade.php " . get_license_version() . "\n\n";
	print "Upgrade License Monitor plugin dababase, host/graph/datasource template, and dataquery.\n";
	print "Usage:\n";
